        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (Player p : Bukkit.getServer().getOnlinePlayers()) {
                    if (mysqlManager.getOrginQuest("daily") != null && mysqlManager.getOrginQuest("daily").equalsIgnoreCase("d7") && mysqlManager.getTutorialQuest(p.getUniqueId().toString()).equalsIgnoreCase("t0") && mysqlManager.getPlayerDailyQuest(1,p.getUniqueId().toString()) == false|| mysqlManager.getOrginQuest("daily") != null && mysqlManager.getOrginQuest("daily").equalsIgnoreCase("d8") && mysqlManager.getTutorialQuest(p.getUniqueId().toString()).equalsIgnoreCase("t0") && mysqlManager.getPlayerDailyQuest(1,p.getUniqueId().toString()) == false) {
