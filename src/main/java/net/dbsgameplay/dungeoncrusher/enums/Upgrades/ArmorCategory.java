...
public class ArmorCategory implements UpgradeCategory {
    ...
    public ArmorCategory(MYSQLManager mysqlManager) {
        ...
        upgradeItems.put(10, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
        upgradeItems.put(11, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
        upgradeItems.put(12, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
        upgradeItems.put(19, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
        upgradeItems.put(20, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
        upgradeItems.put(21, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
        upgradeItems.put(28, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
        upgradeItems.put(29, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
        upgradeItems.put(30, new ShopItem("§7➢ Rüstung Upgrade", Material.PAPER, 25, Arrays.asList("")));
    }

    @Override
    public void openMenu(Player player) {
        String DisplayName = "§f<shift:-8>%oraxen_upgrade_armor%";
